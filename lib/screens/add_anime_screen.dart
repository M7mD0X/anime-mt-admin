...
class _AddAnimeScreenState extends State<AddAnimeScreen> {
  ...
  Future<void> _addAnime() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        setState(() { _message = '✅ Anime added successfully!'; _isLoading = false; });
        _clearFields();
      } else {
        setState(() { _message = '❌ Failed to add anime'; _isLoading = false; });
      }
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Add Anime', style: TextStyle(color: Colors.white)),
          ...
          children: [
            ...
            if (_message.isNotEmpty)
              Container(
                ...
                child: Text(_message, style: TextStyle(color: _message.contains('✅') ? Colors.green : Colors.red)),
              ),
            SizedBox(height: 16),
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: _isLoading
                    ...
                    : Text('Add Anime', style: TextStyle(color: Colors.white, fontSize: 16)),
              ),
            ),
            SizedBox(height: 30),
          ],
  ...
  Widget _sectionTitle(String title) {
    return Padding(
      ...
      child: Text(title, style: TextStyle(color: Color(0xFFE53935), fontSize: 14, fontWeight: FontWeight.bold)),
    );
  }

  Widget _field(TextEditingController controller, String hint, IconData icon, {bool isNumber = false, int maxLines = 1}) {
    return TextField(
